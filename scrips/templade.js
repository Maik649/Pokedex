...
function getShinyCardDialog(pokemon) {
  return `<div class="card-shiny-content">
  <img id="cardImgHeder" src="${pokemon.sprites.front_shiny}" alt="${pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1)
  }" style="width:140px; height:140px">
  <span>${pokemon.past_abilities[0].generation.name.charAt(0).toUpperCase()+ pokemon.past_abilities[0].generation.name.slice(1)}</span>
  </div>`;
  }